...
// import 'package:app_pruebas/domain/models/public_job.dart';
// import 'package:app_pruebas/domain/services/misiontic_interface.dart';
// import 'package:http/http.dart' as http;

// class WorkPoolService implements MisionTicService {
//   final String baseUrl = 'misiontic-2022-uninorte.herokuapp.com';
//   final String apiKey = '3V22/BL.nWYoyCwmVw1wWOhOO5tbQhzYgnjKSH3Ns5BYRw2vln5ay';
